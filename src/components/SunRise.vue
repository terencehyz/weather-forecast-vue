        ...
        methods: {
		    getData() {
		        ...
		        this.$http.get(url).then(function (res) {
		          console.log("????"+res.data.info.results[0].sun.sunrise);
            ...
            async getSun() {
		        ...
		        console.log(url);
		        this.$http.get(url).then(function (res) {
		          console.log("????"+res.data.info.results[0].sun[0].sunrise);

		          _this.day_begin = res.data.info.results[0].sun[0].sunrise;
		          _this.day_end = res.data.info.results[0].sun[0].sunset;
		          _this.sunrise = res.data.info.results[0].sun[0].sunrise;
		          _this.sunset = res.data.info.results[0].sun[0].sunset;
		          _this.showTop();
		        });
		    },
